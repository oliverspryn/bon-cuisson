...
public class _Super_Menu extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    [Bindable(event="propertyChange")]
    public function get perUnit() : String
    {
        return _internal_perUnit;
    }
    ...
    public function set perUnit(value:String) : void
    {
        var oldValue:String = _internal_perUnit;
        if (oldValue !== value)
        {
            _internal_perUnit = value;
        }
    }
