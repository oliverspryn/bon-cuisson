...
?>
//Minimium Flash Player requirement
	var flashMin = '${version_major}.${version_minor}.${version_revision}';
...
//If the hash URL is empty, then we need to redirect to the hashed URL
	if (baseURL.length < URL.length && hijack == '' && swfobject.hasFlashPlayerVersion(flashMin)) {
...
/**
 * Use SWFObject to initialize 
 * the Flash version of the web
 * site
 * ----------------------------
*/
    
    var swfVersionStr = flashMin;
